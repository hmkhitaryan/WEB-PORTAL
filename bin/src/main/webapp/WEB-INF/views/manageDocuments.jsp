                ...
                <c:forEach items="${documents}" var="doc" varStatus="counter">
                    <tr>
                        ...
                        <td><a href="<c:url value='/download-document-${user.id}-${doc.id}' />"
                               class="btn btn-success custom-width"><spring:message code="button.download.label"/></a>
                        </td>
            ...
            <form:form method="POST" modelAttribute="fileBucket" enctype="multipart/form-data" class="form-horizontal">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-lable" for="file"><spring:message
                                code="document.upload.text"/></label>
                        <div class="col-md-7">
                ...
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-md-3 control-lable" for="file"><spring:message
                                code="account.description.label"/></label>
                        <div class="col-md-7">
